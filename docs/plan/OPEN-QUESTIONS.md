...
| **S87** | 🟡 **YENİ, AÇIK — sahibin kararı** | **Zorluk rampası monoton değil ve harita 4-5 Zor'da "referans tahtadan fazlası"nı istemiyor.** Üç körlük kapandıktan sonra ölçülen can kaybı (Zor, gerçekçi referans tahta): **0 · 8 · 6 · 3 · 8** (S88'in sinerjisinden sonra; öncesi 0 · 8 · 6 · 5 · 10). İki tasarım ölçütü karşılanmıyor: (a) rampa monoton değil — harita 2, harita 3 ve 4'ten zor; (b) `difficulty.ts`'in "Zor'da harita 4-5 ≥ 12 can" tanımı tutmuyor (3 ve 8). **Bu yeni bir bozulma değil — oyun hep böyleydi, simülasyon göremiyordu.** Düzeltmek dört haritanın çarpanını yükseltmek demek, yani **oyuncunun deneyimini değiştiren bir tasarım kararı**; tek başına yapılmadı. Ölçülen tarama (Zor / Kolay): h3 ×2,6 → 6/1 · ×3,0 → 14/4 · ×3,4 → 21/13 ‖ h4 ×4,4 → 5/2 · ×5,2 → 14/5 · ×6,0 → 18/14 ‖ h5 ×6,8 → 10/6 · ×8,0 → 19/10 · ×9,2 → 27/15. Kabaca **h3 ≈ 2,8 · h4 ≈ 5,2 · h5 ≈ 7,4–8,0** rampayı monoton yapar ve Zor tanımını karşılar; Kolay'ın ≤ 10 ölçütü h5 = 8,0'da tam sınırda. İki test o karara kadar **ölçülen değerleri kilitliyor** (gevşetilmedi, yer değiştirdi) |
