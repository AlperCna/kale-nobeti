...
| **S22** | ⏳ **ölçüldü, kararı S95'e bağlı** | Patlama hasarı merkeze uzaklığa göre **azalmıyor**. `M11` Faz 4 bunun bedelini ölçtü: alan hasarı bedava bir çarpan ve Top ailesinin baskınlığının ana kaynağı (S95). Azalma uygulandı ve tarandı (kenar %100/50/25/0) ama **tek başına yetmiyor** — Top hâlâ önde, Okçu hâlâ ölü. Sayı, S95'in aile geçişinde Okçu'nun düzeltmesiyle **birlikte** türetilecek; yarım modelde sayı türetmemek S82/S84'ün dersi |
