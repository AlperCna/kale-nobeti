...
describe('Harita 2 ve 3 — GAME-DESIGN.md §9 tablosu', () => {
  ...
  it('zorluk MONOTON artıyor', () => {
     ...
     * 5'inkinden düşük (5,6 < 7,6) ama ölçülen can kaybı **daha yüksek**
     * (18 > 15), çünkü zorluk kadronun kendisinden geliyor: Tünelci
...
describe('Harita 4 — M8-T04', () => {
  it('sayılar ÖLÇÜLDÜ, uydurulmadı (M8-T04-SONUC)', () => {
    ...
    expect(MAP_4.hpMultiplier).toBe(6.4); // S109 → S113
...
describe('Harita 5 - M8-T05', () => {
  it('sayilar OLCULDU, uydurulmadi (M8-T05-SONUC)', () => {
    ...
    // S87 → S91.
    expect(MAP_5.hpMultiplier).toBe(9.2); // S109 → S113
